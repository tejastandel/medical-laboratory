 ...
 * @author supun
 */
public class DoctorRefarals extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Test Name", "Patient Name", "Price"
            }
        ) {
    ...
    private void btnLoadDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoadDataActionPerformed
        ...
        ArrayList<DoctorReferral> doctorReferrals = ReportController.getDoctorReferrals(docName, startDate, endDate);
        tableModel.setNumRows(0);
        for (DoctorReferral refferal : doctorReferrals) {
            tableModel.addRow(new Object[]{refferal.getTestPerformedDate(), refferal.getTestName(), refferal.getPatientName(), refferal.getPrice()});
        }
    ...
    private void btnPrintDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrintDataActionPerformed
        ...
        try {
            PrintManager.printHistory(doctorReferrals, dateFormatter.format(startDate), dateFormatter.format(endDate), docName);
        } catch (JRException | FileNotFoundException | ParseException ex) {
            Logger.getLogger(DoctorRefarals.class.getName()).log(Level.SEVERE, null, ex);
        }
